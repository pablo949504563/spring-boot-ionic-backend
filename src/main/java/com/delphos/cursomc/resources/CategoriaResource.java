...
import com.delphos.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<?> finder(@PathVariable Integer id) {
		Categoria obj = service.finder(id);
	...
	public ResponseEntity<List<CategoriaDTO>> finderAll() {
		List<Categoria> list = service.finderAll();
