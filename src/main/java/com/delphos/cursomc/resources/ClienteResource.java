...
import com.delphos.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> finderAll() {
		List<Cliente> list = service.finderAll();
